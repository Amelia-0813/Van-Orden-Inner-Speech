...
// CHANGED: response keys updated from z/slash to x/m
const KEY_YES = "x";
const KEY_NO  = "m";

// path to the incorrect-answer feedback buzz
const FEEDBACK_AUDIO = "incorrect_buzz.wav"; // <-- replace with your actual file path
...
async function runExperiment() {
  ...
  timeline.push({
    ...
    pages: [
      ...
      // Example 1: mirrors the actual trial sequence (category -> ISI -> word)
      `<div class="instructions-block">
         ...
         <p>You should press <strong>"x"</strong> to indicate "yes".</p>
       </div>`,
      ...
      `<div class="instructions-block">
         ...
         <p>You should press <strong>"m"</strong> to indicate "no".</p>
       </div>`,
      `<div class="instructions-block">
         <p><strong>It's important to respond as accurately and quickly as possible!</strong></p>
         ...
         <p><strong>Remember! Press "x" if the word IS a member of the category and "m" if it is NOT.</strong></p>
  ...
  timeline.push({
    ...
    stimulus: `<div class="instructions-block">
        ...
        <p><strong>Remember: press "x" for yes, "m" for no.</strong> Respond as quickly and accurately as possible.</p>
